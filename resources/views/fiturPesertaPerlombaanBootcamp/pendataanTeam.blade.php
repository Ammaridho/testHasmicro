...
<div class="row mt-3">
  <div class="col-5">
    <input class="form-control" type="search" placeholder="Cari Team.." aria-label="Search" id="textSearchTeam" name="textSearchTeam">
  </div>
</div>
...
<div class="row mt-3">
  <div class="col-lg-6">
    <div class="isitransaksi" style="max-height: 750px; overflow-y:auto; border: 1px solid rgb(185, 185, 185); overflow-x: hidden;" id="listDataTeam">
            ...
            <div class="card-body p-0">
              <div class="row">
                <div class="col-9">
                  ...
                  <div class="row">
                    <div class="col" style="height: 20px">
                      <p class="text-dark">Status : {{ucfirst($item->status)}}</p>
                    </div>
                  </div>
                </div>
                <div class="col-3">
...
<script>
  ...
  // search Team
  $("#textSearchTeam").on("keyup change", function() {
    var value = $(this).val().toLowerCase();

    $("#listDataTeam a").filter(function() {
  ...
  $('#submitjmlpsUbah').on('click',function () {
    ...
    if (jmlPeserta != '') {
      ...
      if(jmlPeserta > 4){
        ...
        $('input[name="jumlahPeserta"]').val('0');
        jmlPeserta = 0;
      }
